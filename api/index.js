...
app.post("/similarities", async (req, res) => {
  ...
  // const overallSimilarity = stringSimilarity.compareTwoStrings(text1, text2);
  ...
  for (let j = 0; j < arrayLength.smallTextArray; j++) {
    ...
    // const similarity = stringSimilarity.compareTwoStrings(text1[j], text2[j]);
